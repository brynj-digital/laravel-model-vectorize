    ...
    public function handle(): int
    {
        ...
        try {
            ...
            if (isset($result['success']) && $result['success']) {
                ...
                $this->line('2. Create metadata index for model filtering:');
                $this->line("   php artisan vectorize:create-metadata-index model string");
                $this->line('3. Import your models: php artisan vectorize:import "App\\Models\\YourModel"');
