    ...
    public function handle(): int
    {
        ...
        try {
            ...
            if (!$accountId || !$apiToken) {
                $this->error('Cloudflare account ID and API token must be configured in config/vectorize.php');
                return Command::FAILURE;
            }
            ...
            if (isset($result['success']) && $result['success']) {
                ...
                $this->line('1. Update your model to include this metadata property in toSearchableArray()');
                $this->line('2. Re-index your data: php artisan vectorize:import "App\\Models\\YourModel"');
                $this->line('3. Use metadata filtering in your searches with where() clauses');
